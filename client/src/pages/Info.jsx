  ...
  return (
    ...
    <div className="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12">
        <div className="w-full lg:w-6/12">
            <h2 className="w-full font-bold lg:text-4xl text-3xl lg:leading-10 leading-9">We are here to create more than just a website our Aim is to build Vibrant community where individual can thrive</h2>
            <p className="font-normal text-base leading-6 text-gray-600 mt-6">At VITBEAT, we envision a campus where every student is empowered to express, connect, and celebrate their unique journey and themselves through a seamless and vibrant platform.</p>
        </div>
        <div className="w-full lg:w-6/12">
